...
<?php echo $this->Form->create('DishRating'); ?>
	<fieldset>
		<legend><?php echo __('Edit Dish Rating'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('DishRating.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('DishRating.id'))); ?></li>
