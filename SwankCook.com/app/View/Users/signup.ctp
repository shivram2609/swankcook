        ...
        <div class="top-space signup-container">
			...
			<h3 class="heading">Sign Up</h3>
			  ...
			  <div class="tab-content">
				...
				<!--div id="user-sign-up" class="tab-pane fade">
				    <form action="#">
					<div class="form-group">
						<input type="text" class="form-control cook-icn" placeholder="User Name">
					</div>
					<div class="form-group">
						<input type="email" class="form-control email-icn" placeholder="Email">
					</div>
					<div class="form-group">
						<input type="password" class="form-control password-icn" placeholder="Password">
					</div>
					
					<div class="form-group">
						<input type="text" class="form-control phone-icn" placeholder="Phone No">
					</div>
					
					<div class="form-group text-right border-top">
						<a href="login.html" title="Login">LOGIN</a> <button title="SIGN UP" class="btn btn1">SIGN UP</button>
					</div>
					<div class="text-center border-top">
                     <div class="form-group clearfix"></div>
						<a href="<?php echo SITE_LINK."login_with_facebook" ?>" title="Login with Facebook" class="btn btn-facebook"><i class="fa fa-facebook" aria-hidden="true"></i> &nbsp;Login with Facebook</a> &nbsp; <a href="<?php echo SITE_LINK."login_with_twitter" ?>" title="Login With Twitter" class="btn btn-info"><i class="fa fa-twitter" aria-hidden="true"></i> &nbsp;Login With Twitter</a>
